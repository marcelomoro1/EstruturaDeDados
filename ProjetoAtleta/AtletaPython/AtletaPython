class Atleta:
    def __init__(self, nome, fone, apelido, data_nascimento, pontuacao):
        self.nome = nome
        self.fone = fone
...
def cadastrar_atleta(Hash, nome, fone, apelido, data_nascimento, pontuacao):
    jogador = Atleta(nome, fone, apelido, data_nascimento, pontuacao)
...
if __name__ == "__main__":
    ...
    while opcao != 5:
        ...
        if opcao == 1:  # Listar Atletas
            ...
            pontuacao = int(input())
            cadastrar_atleta(Hash, nome, fone, apelido, data_nascimento, pontuacao)
